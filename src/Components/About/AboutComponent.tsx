...
export const AboutComponent: FC = () => {
    return (
        <div>
            ...
            <ol>
                <li>
                    Записаться в волонтёры в интересующий парк на нужную дату и нужную позицию. Или записать в
                    волонтёры
                ...
                <li>
                    Можно привязать свой аккаунт 5 вёрст в разделе "Профиль". Это облегчит вам запись в волонтёры,
                    т.к.
                ...
                <li>
                    В разделе "Локации" можно посмотреть информацию о локациях (директоров, статус, возможность
                    записи
                ...
                <li>
                    ...
                    <ol>
                        <li>
                            В списке волонтёрских ролей внутри кнопки "Записаться" появляется "Руководитель". Можно
                            туда
                            записаться.
                        </li>
                        <li>
